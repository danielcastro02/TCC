    ...
    function inserirUsuario()
    {
        ...
        if ($json->success) {
            ...
            if ($_POST['senha1'] == $_POST['senha2']) {
                ...
                if ($parametros->getConfirmaEmail() == 1 && false) {
...
//Fim do bloco de funções do login
    ...
    function removeAdm()
    {
        ...
        if ($linha[0] > 1) {
            ...
            header('location: ../Tela/historicoCliente.php?id_usuario=' . $_GET['id']);
        } else {
            $this->addToast("Você é o ultimo administrador do sistema!");
            header('location: ../Tela/historicoCliente.php?id_usuario=' . $_GET['id'] . '&msg=unicoAdm');
        }
    }

    public
    function adicionaAdm()
    {
        $this->requerAdm();
        $con = new conexao();
        $pdo = $con->getConexao();
